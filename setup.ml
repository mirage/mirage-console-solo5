...
(* OASIS_START *)
(* DO NOT EDIT (digest: 69f42acfe87653744eae3df31b5558af) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Anil Madhavapeddy"; "David Scott"; "Dan Williams"];
          homepage = None;
          synopsis = "Console implementation for Xen and Unix and Solo5";
          description = None;
          categories = [];
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "true to build Solo5 library";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Console_solo5"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "mirage-console";
                      lib_findlib_name = Some "solo5";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\163\255\199\188#:C\018\151\175\148\138I\166q\192";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
