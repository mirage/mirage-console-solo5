...
(* OASIS_START *)
(* DO NOT EDIT (digest: 83c77b0097be81be0f80c8591ebef538) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Console implementation for Solo5";
          description = None;
          categories = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mirage-console", None);
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "mirage-console-solo5";
     ...
     oasis_version = "0.4.6";
     oasis_digest =
       Some "\200+{\198\239\245\238\171\209\004\007\016b\006\170W";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
